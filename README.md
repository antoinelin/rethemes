...
| `defaultTheme`          | `string extends Theme` | true      | Theme you would like to use as default. Based on `themes`. If `defaultTheme` is not includes in `themes` it will be added. |
